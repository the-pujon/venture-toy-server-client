  ...
  return (
    <div>
      <div className="sm:flex sm:flex-col md:relative">
        ...
        <div className="md:absolute md:w-2/6 p-8  md:h-96 md:z-40 md:top-60 md:left-36 md:backdrop-blur-sm md:rounded-md bg-[#a8adafd7] flex justify-center items-center">
